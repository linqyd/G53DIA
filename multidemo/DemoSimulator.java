...
public class DemoSimulator {
	...
	public static void main(String[] args) {
        ...
        for (int i=0; i<FLEET_SIZE; i++) {
            t = new SmartTanker(i*2 + 1, i, wm);
//            wm.taskStatus.put((SmartTanker) t, Boolean.FALSE);
            fleet.add(t);
        }
        ...
        while (env.getTimestep()<(DURATION)) {
            ...
            for (Tanker tanker : fleet) {
                System.out.println(tanker.getCompletedCount());
                System.out.println(tanker.waterDelivered);
                System.out.println(WorldModel.getInstance().taskList.size());
            }
    }
